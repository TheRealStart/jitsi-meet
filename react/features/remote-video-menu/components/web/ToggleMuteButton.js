...
import AbstractToggleMuteButton, {
    _mapStateToProps,
    type Props
} from '../AbstractToggleMuteButton';
 ...
 */
class ToggleMuteButton extends AbstractToggleMuteButton {
    /**
...
export default translate(connect(_mapStateToProps)(ToggleMuteButton));